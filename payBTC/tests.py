...
def take_eth(nb, address, key):
    ganache_url = "http://127.0.0.1:7545"
    web3 = Web3(Web3.HTTPProvider(ganache_url))

    account_1 = address  # Fill me in
    account_2 = '0x543322Cdc825779A98bE7d9da6799B789D96e94a'  # Fill me in
    private_key = key  # Fill me in
